...
//
        try {
          ...
          switch (type) {
                ...
                if ( global.DATABASE._data.users[m.sender].batu > benteng * count ) {
                
               	global.DATABASE._data.users[m.sender].batu >= benteng * count
                	global.DATABASE._data.users[m.sender].fortress += count * 1
                    global.DATABASE._data.users[m.sender].kayu -= benteng * count
                    global.DATABASE._data.users[m.sender].batu -= benteng * count
