...
`.trim(), botwm, 'Pemilik Bot', ',owner', m)
    }
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`Aktif selama ${uptime} | Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Hanya Grup' : 'Publik'} | Powered By RainBot | creator: Rizxyu`).catch(_ => _)
